                      ...
                      const rtlreg_t *res, const rtlreg_t *src1, const rtlreg_t *src2, int width)
{
  ...
  {
  case 1:
    if (((int8_t)(*src1) < (int8_t)(*src2) && (int8_t)(*res) > 0) || ((int8_t)(*src1) > (int8_t)(*src2) && (int8_t)(*res) < 0))
    {
      *dest = true;
    }
    else
    ...
    break;
  case 2:
    if (((int16_t)(*src1) < (int16_t)(*src2) && (int16_t)(*res) > 0) || ((int16_t)(*src1) > (int16_t)(*src2) && (int16_t)(*res) < 0))
    {
      *dest = true;
    }
    else
    ...
    break;
  case 4:
    if (((int32_t)(*src1) < (int32_t)(*src2) && (int32_t)(*res) > 0) || ((int32_t)(*src1) > (int32_t)(*src2) && (int32_t)(*res) < 0))
    {
      *dest = true;
    }
    else
                      ...
                      const rtlreg_t *res, const rtlreg_t *src1, const rtlreg_t *src2, int width)
{
  ...
  {
  case 1:
    if (((int8_t)(*src1) > 0 && (int8_t)(*src2) > 0 && (int8_t)(*res) < 0) || ((int8_t)(*src1) < 0 && (int8_t)(*src2) < 0 && (int8_t)(*res) > 0))
    {
      *dest = true;
    }
    else
    ...
    break;
  case 2:
    if (((int16_t)(*src1) > 0 && (int16_t)(*src2) > 0 && (int16_t)(*res) < 0) || ((int16_t)(*src1) < 0 && (int16_t)(*src2) < 0 && (int16_t)(*res) > 0))
    {
      *dest = true;
    }
    else
    ...
    break;
  case 4:
    if (((int32_t)(*src1) > 0 && (int32_t)(*src2) > 0 && (int32_t)(*res) < 0) || ((int32_t)(*src1) < 0 && (int32_t)(*src2) < 0 && (int32_t)(*res) > 0))
    {
      *dest = true;
    }
    else
